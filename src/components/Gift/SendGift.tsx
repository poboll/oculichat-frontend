...
const SendGiftModal: React.FC<Props> = (props) => {
  ...
  const randomTexts = ["注册即送100坤币💰奖励，Cai-API 接口开放平台为您提供稳定、安全、高效的接口调用服务！",
    "免费领取100坤币💰奖励，通过链接注册，Cai-API 接口开放平台为您提供稳定、安全、高效的接口调用服务！",
    "通过链接注册，即可获得100坤币💰奖励，Cai-API 接口开放平台为您提供稳定、安全、高效的接口调用服务！"];
